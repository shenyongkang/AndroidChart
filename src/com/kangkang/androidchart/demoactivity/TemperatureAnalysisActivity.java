...
import com.kangkang.androidchart.demoactivity.TemperatureActivity.MyYAxisValueFormatter;

public class TemperatureAnalysisActivity extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.temperature_analysis);
		double[] yValues = { 37.0, 37.5, 36.8, 37.2, 36.20, 36.0, 37.4 };
		String[] labels = { "1", "3", "5", "7", "9", "21", "23" };
		LineChart myChart = (LineChart) findViewById(R.id.temperatureAnalysis);
		setChart(myChart, labels, yValues);
	}

	private void setChart(LineChart myChart, String[] labels, double[] yValues) {
		...
		for (int i = 0; i < yValues.length; ++i) {
			...
			dataEntries.add(new Entry((float) yValues[i], i*2+1));
		}
